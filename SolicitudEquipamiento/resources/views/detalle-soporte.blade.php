...
<div class="card">
  <div class="card-header" data-background-color="green">
      <h4 class="title">Detalle Solicitud</h4>
  </div>
  <div class="card-content table-responsive">
    <div class="form-group">
      <label for="inputEmail1" class="col-lg-2 control-label">Tipo</label>
      <div class="col-lg-10">
        <select disabled name="kind_id" class="form-control" required onchange="location = this.value;">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" disabled name="title" required class="form-control" id="inputNombre" placeholder="Titulo" value="" >
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail1" class="col-lg-2 control-label">Asunto</label>
      <div class="col-lg-10">
        <input type="text" disabled name="title" required class="form-control" id="inputAsunto" placeholder="Titulo" value="">
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail1"  class="col-lg-2 control-label">Tipo de solicitante</label>
      <div class="col-lg-10">
        <input type="text" disabled name="title" required class="form-control" id="inputNombre" placeholder="Titulo" value="" readonly>
      </div>
    </div>
    <br><br>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <select disabled name="kind_id" class="form-control" required>
    ...
    <div class="form-group">
      <label for="inputEmail1" class="col-lg-2 control-label">Codigo del equipo</label>
      <div class="col-lg-10">
        <input type="text" name="title" required class="form-control" id="inputNombre" placeholder="Titulo" value="-">
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail1" class="col-lg-2 control-label">Modelo</label>
      <div class="col-lg-10">
        <input type="text" name="title" disabled required class="form-control" id="inputModelo" placeholder="Titulo">
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail1" class="col-lg-2 control-label">Numero de serie</label>
      <div class="col-lg-10">
        <input type="text" name="title" disabled required class="form-control" id="inputNumeroSerie" placeholder="Titulo">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <textarea name="comment" required class="form-control" id="inputNombre" placeholder="Titulo" rows="5" cols="40"></textarea>
      </div>
    </div>
    <div class="form-group">
      <div class="col-lg-offset-2 col-lg-10">
        <a href="{{ url('/ticket-soporte')}}"><input type="submit" class="btn btn-default" value="Volver" ></a>
        <a href="ticket.html"><input type="submit" id="BCancelar" value="Modificar" ></a>
      </div>
