...
<div class="card">
  ...
  <div class="card-content table-responsive">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" name="title" required class="form-control" id="inputModelo" value="Cisco Systems">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <select name="kind_id" class="form-control" required>
          <option value="redes">Catalyst 2900</option>
          <option value="redes">Catalyst 2800</option>
          <option value="redes">Catalyst 1800</option>
          <option value="redes">Catalyst 2950</option>
          <option value="redes">Catalyst 2960</option>
          <option value="redes">Catalyst 3560</option>
          <option value="redes">Catalyst 3550</option>
        </select>
      </div>
    </div>
    <div class="form-group">
