...
<div class="card">
  ...
  <div class="card-content table-responsive">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" name="title" required class="form-control" id="inputNombre" placeholder="Titulo" value="Administrador">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <select name="kind_id" class="form-control" required onchange="location = this.value;">
          <option value="layout.php">Alumno</option>
          <option value="layoutRedes.php">Profesor</option>
          <option value="layoutRedes.php">Administrativo</option>
        </select>
      </div>
    </div>
    <br><br>
